class Calculator {
    ...
    getDisplayNumber(number) {
        ...
        let integerDisplay
        /* below if happens when someone enters nothing or enter '.' */
    ...
    updateDisplay() {
        this.resultElement.innerText = this.getDisplayNumber(this.currentOperant);
        if (this.operation != null) {
            this.calcElement.innerText = `${this.getDisplayNumber(this.previousOperant)} ${this.operation}`;
            return;
        }
        this.calcElement.innerText = this.previousOperant;
    }
}
